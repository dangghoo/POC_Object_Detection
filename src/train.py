"""
Fine-tune YOLOv8-nano on the bowl dataset.
...
def main():
    parser = argparse.ArgumentParser(description="Train YOLOv8 for bowl detection")
    ...
    parser.add_argument("--name", default="bowl_v1")
    ...
    print(f"\nTo run inference:")
    print(f"  python src/detect.py --weights {best_weights} --image sample_data/top_left.png")
    print(f"\nTo evaluate on all sample images:")
    print(f"  python src/evaluate.py --weights {best_weights}")
